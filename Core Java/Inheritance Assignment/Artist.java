...
class TestArtist{
	public static void main(String[] args) {
		Painter p1=new Painter("Pablo Picasso", 91, "Cubism", "Oil Painting", 1500);
		Musician m1=new Musician("Shankar Mahadevan", 59, "Vocals", "Film Music", 30);
		Actor a1=new Actor("Vijay Deverakonda", 37, "Telugu Cinema", 20);
