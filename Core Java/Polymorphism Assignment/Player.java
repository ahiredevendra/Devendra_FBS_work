...
class TestPlayer{
	public static void main(String[] args) {
		...
		Player[] p;
		p=new Player[2];
		p[0]=new CricketPlayer("Rohit Sharma",39,"India",514,45,20363,12,"Right-handed","Right-arm-off-break");
		p[1]=new FootballPlayer("Lionel Messi", 39, "Argentina", 190, 10, 850, "Forward");
