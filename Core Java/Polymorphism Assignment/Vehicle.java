...
class Bus extends Vehicle{
	...
	void brake() {
		System.out.println("Bus Brake Appled!!");
	}
...
class TestVehicle{
	public static void main(String[] args) {
		...
		arr[0]=new Bike("MH19AB1234","Pulsar 150","Bajaj",2,120000,2,2,"Sports");
		arr[1]=new Car("MH19CD5678","Creta","Hyundai",4,1500000,true, "Automatic",true);
		arr[2]=new Bus("MH19EF9012","Volvo 9400","Volvo",6,8000000,50,20);
